...
public static class DatabaseExtension
{
    ...
    public static void AddApplicationContext(this IServiceCollection services, DbConfig dbConfig)
    {
        ...
        {
            case "mysql":
                services.AddDbContext<KirelLogMessageContext, KirelLogMysqlMessageContext>(contextOptions);
                break;
            case "postgresql":
                services.AddDbContext<KirelLogMessageContext, KirelLogPostgresqlMessageContext>(contextOptions);
                break;
            case "mssql":
                services.AddDbContext<KirelLogMessageContext, KirelLogMssqlMessageContext>(contextOptions);
                break;
        }
    }
